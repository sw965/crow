...
func TestAbsZForScale(t *testing.T) {
	tests := []struct {
		...
		{name: "正常_入力数が小さく切り捨てで0になるなら1", fanIn: 9, num: 1, denom: 4, want: 1},
		{name: "正常_49入力_1/8は切り捨てで0になるので1", fanIn: 49, num: 1, denom: 8, want: 1},
		{name: "正常_倍率がごく小さく切り捨てで0になるなら1", fanIn: 784, num: 1, denom: 100, want: 1},
		{name: "正常_入力数が小さくても倍率0なら0", fanIn: 9, num: 0, denom: 4, want: 0},
