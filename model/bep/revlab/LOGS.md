...
```powershell
go run ./model/bep/revlab --mode dense --dataset mnist --epochs 20 --bias=false --biaschoice 0 --seed 1 --threads 4
go run ./model/bep/revlab --mode reversible --blocks 2 --learnrev=false --dataset mnist --epochs 20 --bias=false --biaschoice 0 --seed 1 --threads 4
go run ./model/bep/revlab --mode reversible --blocks 2 --learnrev=true --dataset mnist --epochs 20 --bias=false --biaschoice 0 --seed 1 --threads 4
go run ./model/bep/revlab --mode reversible --blocks 2 --learnrev=true --dataset mnist --epochs 20 --bias=true --biaschoice 0.1 --seed 1 --threads 4
```
