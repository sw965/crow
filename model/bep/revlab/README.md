...
```powershell
go run ./model/bep/revlab --mode reversible --blocks 2 --epochs 20 --seed 1
```

バイアスを切って可逆構造だけ比較する場合:

```powershell
go run ./model/bep/revlab --mode reversible --blocks 2 --bias=false --biaschoice 0 --epochs 20 --seed 1
```
