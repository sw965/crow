...
```powershell
go run ./model/mlp/binary/glulab -arch plain
go run ./model/mlp/binary/glulab -arch wide
go run ./model/mlp/binary/glulab -arch wider2048
go run ./model/mlp/binary/glulab -arch gated -route cheap -noise 0.25
go run ./model/mlp/binary/glulab -arch plain -noisekind uniform
go run ./model/mlp/binary/glulab -arch plain -lrnum 1 -lrden 10
go test -run "^$" -bench BenchmarkPredict -benchtime 200000x ./model/mlp/binary/glulab/
```
